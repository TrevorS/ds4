...
cpu: ds4_cli_cpu.o ds4_server_cpu.o ds4_bench_cpu.o ds4_eval_cpu.o ds4_agent_cpu.o ds4_web.o ds4_kvstore.o linenoise.o rax.o $(CPU_CORE_OBJS)
	...
	$(CC) $(CFLAGS) -o ds4-bench ds4_bench_cpu.o ds4_kvstore.o $(CPU_CORE_OBJS) $(LDLIBS)
...
ds4-bench: ds4_bench.o ds4_kvstore.o $(CORE_OBJS)
	$(NVCC) $(NVCCFLAGS) -o $@ $^ $(CUDA_LDLIBS)
...
clean:
	rm -f ds4 ds4-server ds4-bench ds4-eval ds4-agent ds4_cpu ds4_native ds4_server_test ds4_test libds4.so *.o tests/cuda_long_context_smoke tests/cuda_long_context_smoke.o
